        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl font-archivo text-lg text-bark">
              Residential Magnum stripes, an azalea black-mulch after, commercial grounds with the trailer, and Walker stripes. Captions match the files. No stock. No crew shots. Owner headshot in the about section.
            </p>
          </div>
