        ...
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mb-6 max-w-md font-barlow text-lg leading-relaxed text-white/70">
              Lawn care from Walker. Run by Michael Dantone — solo operator since 2013. Weekly route is Walker, Denham Springs, and Watson. Same day, work I put my name on. Need property care? Request a free estimate.
            </p>
